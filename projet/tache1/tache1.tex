...
$$
	\left\{
		\begin{array}{rl}
			C_{p_{N_{2}}}(T) 	&= 27.62 + 4.19\cdot10^{-3}T + (0\cdot10^{-6})T^2\\
			C_{p_{H_{2}}}(T)	&= 29.3 - 0.84\cdot10^{-3}T + (2.09\cdot10^{-6})T^2\\
			C_{p_{NH_{3}}(T) 	&= 31.81 + 15.48\cdot10^{-3}T + (5.86\cdot10^{-6})T^2 \\
		\end{array}
	\right
$$
