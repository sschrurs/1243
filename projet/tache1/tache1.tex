...
\textsc{Schrurs} S\'ebastien (7978-13-00)}
\date{\today} 
\begin{document}
...
\section{Sources des réactifs}
	...
	à \numprint{99,99}\%. Cette méthode est efficace pour une consommation au-delà de $\unit{200}{\meter\cubed\per\hour}$. 
	...
	débits forts variables ($\unit{3-1000}{\meter\cubed\per\hour}$).
	...
	Un désavantage de cette méthode par rapport aux 2 premières est qu'il faut acheter les réactifs. De plus, il faut utiliser de l'énergie pour chauffer la réaction.

	\subsection{Sources de dihydrogène}
		\subsubsection{Vaporeformage de méthane}
		2 réactions sont utilisées pour ce procédé :
		...
		\end{chemmath}
			...
			méthode est qu'elle rejette une grande quantité de \chemform{CO_2}, gaz à effet de serre.
		...
		L'inconvénient de cette méthode est son faible rendement.
	...
	et est peu coûteuse. En pratique, cette méthode est très peu utilisée.
